...
%----------------------数据预设---------------------------------------------
%----降水数据
TMPA_idir='E:\DATA\2.Satellite\TMPA_3B42_V7_Daily\';
odir='D:\DATA\TC_spatial_data\pre_amount\TMPA\';
% Outname='TMPA_TC_AVE_PreRate_Day025_500km_Ummd';
Outname='TMPA_TC_PreAmount_Day025_500km_Um3';
% Excel_file='D:\Desktop2\Attri-project\Results\Otherdatasets\TMPA_100500.xlsx';
...
RMRflag=0;                                                              %改
NOlim=lim_Y2NO([1998,2019],ISO_TIME);                                   %改
NODATA_value=-9999;                                                     %改
...
for NO=ST:EN
    ...
    for k=1:length(allday)
        ...
        alldata(:,:,k)=flipud(fulldata025);%上下反转，然后重采样
    end
    alldata(alldata<0)=0;
