...
odir='D:\DATA\TC_spatial_data\IMERG_FV7B_PRE01\';
...
for NO=1:NOlim(3)
    ...
    for d=1:length(allday)                                              %DayBF不要才能和lat数量对上，实际上是unique numtime，时间顺序应该是不会变的所以第一个和最后一个剪掉就行
        ...
        Iradius=100;
        [Buff_OWZ,Buff_OMask,Buff_IWZ,Buff_IMask] = TCLine2Buffer_GPU(WZ,Oradius,Iradius,cs,LonCT_gpu,LatCT_gpu,Dailydata,RMRflag);
