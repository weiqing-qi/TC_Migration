function [Buff_OWZ,Buff_OMask,Buff_IWZ,Buff_IMask,RMR] = TCLine2Buffer_GPU(WZ,Oradius,Iradius,cs,LonCT_gpu,LatCT_gpu,Dailydata,RMRflag,DRMW)
...
TGCLON=zeros(180/cs*360/cs,1,'gpuArray'); %ALL Grid size initialization
TGCLAT=zeros(180/cs*360/cs,1,'gpuArray');
Buff_OMask=zeros(180/cs,360/cs,'gpuArray');
Buff_IMask=zeros(180/cs,360/cs,'gpuArray');
