function [weizhi,passyear,passmonth,passday,locationR,locationC] = TC_pass_period_V1(header,raster,year,month,day,lon,lat,ran)
%This is an update version of calculate time of each grid from TCRoutedata 0-360 
%The passing time is calculated rigidly, including every period it appeared
%in 500 km. And we add the former & later 1 day.
%update2023.9.6
%这个逻辑必须lonlat与输入的时间数组大小对应
%raster：500 km buffer 0-360，ran：遍历每个轨迹点搜寻经过时间的时候的半径一般和bufferraster的搜索半径一样
