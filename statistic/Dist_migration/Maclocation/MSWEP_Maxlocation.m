...
odir='F:\GlobalTCMask1\single_pre\MSWEP_Single_Precip3d_mmd\';
...
% STRdate=num2str(allday(k));                                             %1980-2016
% Amondata = ncread([MSWEP_idir,STRdate(1:6),'.nc'],'precipitation');%1980-2016
% allpre(:,:,k)=Amondata(:,:,str2double(STRdate(7:8)))';
end
...
%OUTPUT(odir,['MSWEP_Ori_SingleTC_3dPrecip_Ummd','_SID',SID(:,NO)'],header,TCpre);%MM/DAY
