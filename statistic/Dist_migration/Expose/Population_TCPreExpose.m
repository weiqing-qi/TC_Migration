...
%用环剪切得到每年每环人口数
clear; clc; close all;
file_idir='C:\Users\29585\Desktop\Desktop2\Global_cyclone_project\Picture_materials\ARCGIS\CoastLine110m\Coast_Buffer_txt\';
filename = 'ns60_coast_bothside_buffer';%注意是不是按顺序储存的
%陆地国家数据
[~,~,Clandmask] = read_ARCascii('C:\Users\29585\Desktop\Desktop2\Global_cyclone_project\Picture_materials\ARCGIS\Rastermasks\countriesmasks.txt');%陆地和国家0360
...
%% 计算一年中最大降水强度分布和人口分布
indir='F:\GlobalTCMask1\single_pre\JRA55_Single_Precip3d_mmd\'; %改
MaxPre=zeros(360,720,41);
parfor y=1980:2020
    files=dir([indir,'JRA555_Ori_SingleTC_3dPrecip_Ummd_SID',num2str(y),'*.txt']);%MM/D注意单位 %改
...
PopDistri_TCP=zeros(360,720,41);%每年经历台风降水的人
