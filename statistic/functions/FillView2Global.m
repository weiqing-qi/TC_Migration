...
if L_leftlon + H(5)*H(1)>=180                                              %一定是">=" yes-> 0-360 no-> -180-180
    ...
    LRFG=[LRFG(:,round(180/H(5))+1:round(360/H(5))),LRFG(:,1:round(180/H(5)))];
else
...
Ufill=repmat(H(6), round((90-U_toplat)/H(5)), round(360/H(5)));
Dfill=repmat(H(6), round((90+D_bottomlat)/H(5)), round(360/H(5)));

LRUDFG=[Ufill;LRFG;Dfill];

[R,C]=size(LRUDFG);

if R==round(180/H(5)) && C==round(360/H(5))
    Full_V=LRUDFG;
else
    Full_V='error extend';
end
