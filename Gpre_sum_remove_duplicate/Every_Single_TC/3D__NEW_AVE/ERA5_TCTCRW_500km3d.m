...
ERA5_idir='E:\DATA\ERA5\ERA5-Total-Column-Rain-Water\';
odir='F:\GlobalTCMask1\single_pre\ERA5\';
ERAfilename='ERA5_Total_Column_Rain_Water_on_single_levels_daily';
...
for k=1:length(allday)
    ...
    Amonthdata = ncread([ERA5_idir,ERAfilename,STRdate(1:6),'.nc'],'tcrw');%每一个allday对应一个allpre
