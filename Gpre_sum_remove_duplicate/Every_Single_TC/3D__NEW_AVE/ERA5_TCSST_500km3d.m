...
S_TC_Pre=zeros(8171,1);
S_Land_Pre=zeros(8170,1);%每场台风的陆地降水
MaximumPre=zeros(8170,1);%每场台风的最大降水
MaximumLPre=zeros(8170,1);%每场台风的最大陆地降水
MaximumPre10grid=zeros(8170,1);%每场台风的最大降水
MaximumLPre10grid=zeros(8170,1);%每场台风的最大陆地降水

for NO=7064:13476 %注意年分1950开始
